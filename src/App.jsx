  ...
  return (
    <div className='w-full app-wrap h-full'>
      ...
      <section className="header-section px-10 mob:px-16 pb-12 relative w-full h-full flex flex-col items-center justify-center gap-0 lg:flex-row lg:px-24">
        ...
        <div className="flex grow flex-col w-full justify-center lg:w-[45%]">
          <Typo
            header={
            ...
            content={
              <p className='txt-body text-center leading-8 text-justify lg:ml-[2rem] lg:leading-8 mob2:text-left' >
      ...
      <section className="header-section4 px-10 mob:px-16 py-[8rem] relative w-full h-full flex flex-col items-center justify-center gap-0 lg:flex-row lg:px-24">
        <div className="flex w-full flex-col lg:items-center lg:flex-row mob:gap-4  lg:w-[65%]">
          <div className="fst-imgs  w-full grow bg-red-200 md:grow  lg:min-h-[10rem] mb-10 md:mb-4 lg:mr-[-2rem] z-10 ">
            <img className=' object-cover w-full lg:w-full h-full md:h-[18rem]'  src={F5} />
          </div>
        ...
        <div className="my-texts2  flex grow flex-col items-center w-full justify-center lg:w-[45%]">
          <Typo
            header={
              <h2 className="w-[20rem] font-thin text-3xl leading-10 text-left tab:w-full tab:text-left font-serif tab:leading-10 tracking-wider lg:ml-[2rem] lg:leading-loose">
                Helping Women feel more confident in health & Body
              </h2>
            }
